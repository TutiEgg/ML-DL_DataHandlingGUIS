...
################################################################################
## Form generated from reading UI file 'ui_main_09_05_2023.ui'
##
...
"}")
        icon = QIcon()
        icon.addFile(u"images/AITAD_logo.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.lab_person.setPixmap(QPixmap(u"images/AITAD_logo.png"))
...
"}")
        ...
        self.frame_settings_input = QFrame(self.frame_settings_main)
        self.frame_settings_input.setObjectName(u"frame_settings_input")
        self.frame_settings_input.setFrameShape(QFrame.StyledPanel)
        self.frame_settings_input.setFrameShadow(QFrame.Raised)
        self.horizontalLayoutWidget = QWidget(self.frame_settings_input)
        self.horizontalLayoutWidget.setObjectName(u"horizontalLayoutWidget")
        self.horizontalLayoutWidget.setGeometry(QRect(9, 9, 251, 341))
        self.frame_settings_parameter = QHBoxLayout(self.horizontalLayoutWidget)
        self.frame_settings_parameter.setObjectName(u"frame_settings_parameter")
        self.frame_settings_parameter.setContentsMargins(0, 0, 0, 0)
        self.plainTextEdit = QPlainTextEdit(self.horizontalLayoutWidget)
        self.plainTextEdit.setObjectName(u"plainTextEdit")

        self.frame_settings_parameter.addWidget(self.plainTextEdit)

        self.horizontalLayoutWidget_2 = QWidget(self.frame_settings_input)
        self.horizontalLayoutWidget_2.setObjectName(u"horizontalLayoutWidget_2")
        self.horizontalLayoutWidget_2.setGeometry(QRect(279, 9, 191, 181))
        ...
        self.horizontalLayoutWidget_3 = QWidget(self.frame_settings_input)
        self.horizontalLayoutWidget_3.setObjectName(u"horizontalLayoutWidget_3")
        self.horizontalLayoutWidget_3.setGeometry(QRect(279, 219, 191, 131))
        ...
        self.button_settings_start = QPushButton(self.horizontalLayoutWidget_3)
        self.button_settings_start.setObjectName(u"button_settings_start")
        self.button_settings_start.setMouseTracking(True)

        self.frame_settings_buttons.addWidget(self.button_settings_start)


        self.verticalLayout_5.addWidget(self.frame_settings_input)
...
"}")
        ...
        self.lab_settings_strat_disc.setFont(font2)
...
"}")
        ...
        self.textBrowser_plan = QTextBrowser(self.page_plan)
        ...
        self.verticalScrollBar_plan = QScrollBar(self.page_plan)
        ...
        self.horizontalSlider_plan = QSlider(self.page_plan)
        ...
        self.lab_recording_main.setFont(font3)
...
"}")
        ...
        self.line_label4.setFont(font4)
...
"}")
        ...
        self.line_label2.setFont(font4)
...
"}")
        ...
        self.line_label3.setFont(font4)
...
"}")
        ...
        self.bn_recording_start.setFont(font4)
...
"}")
        ...
        self.bn_recording_connect.setFont(font4)
